...
Ces éléments de cours consistent en des sous-sections pouvant inclure 1 ou plusieurs vidéos d'animations. Pour qu'un lien vers une vidéo (Vimeo uniquement pour l'instant) soit reconnu comme video de cours,  on utilise le principe des *attribute lists* (cf ci-dessus) en ajoutant la classe `cours_video`:  
    ...
    [Introduction au web](https://player.vimeo.com/video/138623497){: .cours_video } 

ou  

    [Introduction au web](https://player.vimeo.com/video/138623497){: class="cours_video" } 
...
* pour l'export Moodle/IMSCC, le lien est éventuellement reformaté pour respecter le format `http://vimeo.com/video_id` qui permet au plugin Viméo de Moodle de transformer le lien vidéo en iframe automatiquement:
